...
@section('content')
    <section class="section">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page__heading">Roles</h1> |
                            @can('crear-rol')
                                    <a href="{{ route('roles.create') }}"><i class="fa-solid fa-file-medical fa-2x"></i></a>
                            @endcan
                            |
                    </div> 
        ...
        <table id="roles" class="table table-bordered shadow-lg mt-4" style="width:100%">
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            ...
                            @can('borrar-rol')
                                ...
                                {!! Form::open(['route' => ['roles.destroy',$rol->id], 'class' => 'formulario-eliminar' ]) !!}
